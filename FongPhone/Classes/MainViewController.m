...
- (void)viewDidLoad
{
    ...
    //[self.theTabBar didSelectItem:[self.theTabBar.items firstObject]];
    self.theTabBar.selectedItem = [self.theTabBar.items firstObject];
...
- (void)webViewDidFinishLoad:(UIWebView*)theWebView
{
    ...
    baseUrl = theWebView.request.URL.relativeString;
    NSLog(@"%@", baseUrl);
